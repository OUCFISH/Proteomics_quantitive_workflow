...
GSEAplot_fun <- function(temp_df,GSEA_result, geneSetID, title = "", base_size = 11,
                      ...
                      thrid_color = "bl2rd", show_zero = TRUE, zero_font_size = 10, zero_font_family = "Arial", zero_font_color = "#000000", ## 下图区 标记 0 值
...
main <- function(conf) {
  ...
  outdir <- "result/11_AdcancedPlot/11.4_GSEA-multiPathwayPlot/GO"
